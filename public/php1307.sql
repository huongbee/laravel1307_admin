...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2017 at 05:17 AM
...
INSERT INTO `users` (`id`, `username`, `password`, `fullname`, `birthdate`, `gender`, `address`, `email`, `phone`, `remember_token`, `status`) VALUES
(2, 'huonghuong', '$2y$10$TX2owO3FEjc55eCu1RPPQeJTmHUWCpCCKtB.4Nk/2IeYsxgqk4Y.2', 'Hương Hương', '2017-11-02', 'nu', 'Quận 1', 'huongnguyenak96@gmail.com', '098765432', 'DoEmobRxozCqgGGHIj0PjZZ8uuEa9bXIWUwjHbNFsTBmlzb2StVFboHvpQmj', 1);
...
ALTER TABLE `foods`
  ...
  ADD CONSTRAINT `sdsd` FOREIGN KEY (`id_url`) REFERENCES `page_url` (`id`);
